...
function Menu() {
    return (
        <CircleMenu className="ow-menu" as="ul">
            ...
            <Option from={22.5} to={67.5} label="Hello" hotkey="3" offset={-240} style={{ paddingRight: '4em' }}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
            ...
            <Option from={67.5} to={112.5} label="Need healing" hotkey="X" offset={-280}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
            ...
            <Option from={112.5} to={157.5} label="Group up" hotkey="G" offset={-240} style={{ paddingRight: '2.5em' }}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
            ...
            <Option from={202.5} to={247.5} label="Voice line" hotkey="6" offset={-240} style={{ paddingLeft: '2em' }}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
            ...
            <Option from={247.5} to={292.5} label="Acknowledge" hotkey="F" offset={-280}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z" />
                </svg>
            </Option>

            <Option from={292.5} to={337.5} label="Thank" hotkey="4" offset={-240} style={{ paddingLeft: '4em' }}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
    ...
    return (
        <Segment as="li" className="ow-option" gapBefore={1} gapAfter={1} {...rest}>
            <Layout as="button" className="ow-option__button" justify="start" aria-label={label}>
                ...
                <Label className="ow-option__label" offset={offset} style={styleProp}>
                    {label}
                </Label>
